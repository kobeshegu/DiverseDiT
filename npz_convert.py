...
def create_npz_from_sample_folder(sample_dir, num=50_000,save_path=None):
    """
    convert a folder of .png samples to a .npz file
    input: sample_dir: the directory containing the .png samples
           num: the number of samples to convert
           save_path: the path to save the .npz file
    output: the path to the saved .npz file
    """
    samples = []
