...
YOUR_EXPERIMENT_NAME="contextual_self_flow_sit_b2_no_repa_seed0"
...
CUDA_VISIBLE_DEVICES=0 accelerate launch train.py \
  ...
  --self-flow-contextual \
  --self-flow-contextual-depth-pairs=4:8,8:12 \
  --self-flow-contextual-pair-weights=0.75,0.25 \
  --self-flow-contextual-hidden-dim=768
